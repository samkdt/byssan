...
<iframe src="./order.json" id="json">
</iframe>
<script>

function display() {
	document.getElementById('json').contentWindow.location.reload(true);
        ordrar = JSON.parse( window.frames["json"].contentDocument.body.innerText );
